...
class RoundRobinScheduler:
    ...
    def schedule(self, all_tasks: List[BrowserWorkerTask], last_assigned_worker: List[str], n_workers: int, worker_status: Optional[List[Dict[str, Any]]] = None) -> SchedulerOutput:
        """
